...
if __name__ == '__main__':
    ...
    train_data_path = r'/home/wangshenyu/application/paper_fuzzing/attack_server/modbus_attack_server/attack_server_result/coap/coap_tcp/seqgan/in/frame_fuzzing1'
