...
def parse_args(outputdir, data_file, seq_size):
    ...
    parser.add_argument('--dropout_rate', type=float, default=0.3) # 0.3
...
def main():
    data_resp_list = [
        r"/home/shenyuwang/paper_fuzzing/workspace/data/coap/testing_set"
    ...
    output_dir_root_list = [
        r"/home/shenyuwang/paper_fuzzing/workspace/output/coap/Fast_RoPEGAN_without_Fast_RoPEAttention",
    ...
    # output_dir_root = r"G:\研究生\研究生\科研\小论文\FCS-21046_Proof_hi\代码2\WGAN\output\coap\improved_wgan\train1"
        ...
        for args in args_set:
            ...
            for epoch_model_file in os.listdir(args.outputdir):
                epoch_model_file_path =  args.outputdir + os.path.sep + epoch_model_file
                ...
                with tf.Session() as sess:
                    ...
                    gan.load(epoch_model_file_path)
                    #gan.build_model()
